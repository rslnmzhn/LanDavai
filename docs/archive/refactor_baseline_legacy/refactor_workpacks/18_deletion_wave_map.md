...
| weak entry-flow coverage for post-refactor surfaces | `10` | Wave D | UI regressions covered for all weak flows. No remaining deletion blockers for workpack 10. | `test/smoke_test.dart`, `test/blocked_entry_flow_regression_test.dart`, `test/files_entry_flow_regression_test.dart`, `test/remote_share_viewer_flow_regression_test.dart`, `test/history_entry_flow_regression_test.dart`, `GATE-08` |
