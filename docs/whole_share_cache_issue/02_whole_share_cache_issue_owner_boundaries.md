...
| `TransferSessionCoordinator` | Request batching, sender approval state, receiver startup, sender preparation, live transfer/session truth, ephemeral prepared-scope reuse | It does not own canonical browse tokens or persisted index truth |
...
| --- | --- | --- |
| Indexed truth | `SharedCacheIndexStore` entries plus folder/tree and scoped-selection fingerprints | Sender-side selection resolution and safe reuse gating |
